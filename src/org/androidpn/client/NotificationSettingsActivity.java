...
public class NotificationSettingsActivity extends PreferenceActivity {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        CheckBoxPreference notifyAuto = new CheckBoxPreference(this);
        notifyAuto.setKey(Constants.SETTINGS_AOTOSTART);
        notifyAuto.setTitle("AOTOSTART");
        notifyAuto.setSummary("AOTOSTART");
        notifyAuto.setDefaultValue(true);
