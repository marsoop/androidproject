...
public class NotificationDetailsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("-----详情---标题-------》"+notificationTitle);
        ...
        System.out.println("-----详情----图片下载地址->"+notificationImageUrl+"标题-------》"+notificationTitle);
    ...
    private View createView(final String title, final String message,
        ...
        System.out.println("-------网络下载地址---------");
        //空缓存
        ImageLoader imageLoader = new ImageLoader(MyApplication.getHttpRequestQueue(), new ImageCache(){
